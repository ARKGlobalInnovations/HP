              ...
              <div class="col-lg-12">
                <div class="box">
                  <header>
                    ...
                    <?php $req = mysql_query("SELECT * FROM defaultitems");
                    //echo "SELECT * FROM defalultitems WHERE roomType='living room'";
                     ?>
                    <h5>Items Table</h5>
                  </header>
                  <div id="collapse4" class="body">
                    <table id="dataTable" class="table table-bordered table-condensed table-hover table-striped">
                      ...
                      <tbody>
                      <?php $i=1; while($res = mysql_fetch_assoc($req)){ 
                          //print_r($res);
                        ?>
                        <tr>
                          <td><?php echo $i; ?></td>
                           <td><?php if($res['roomType']) { echo $res['roomType']; }?></td>
                          <td><?php if($res['itemType']) { echo $res['itemType']; }?></td>
                          <td><?php if($res['itemName']) {  echo $res['itemName']; }?></td>
                          <td><?php if($res['weight']) {  echo $res['weight']; }?></td>
